          ...
          <div id={`hero-card-${mainArticle.id}`} className="bg-[#f1efe9] p-5 border-2 border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] lg:hover:shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] transition-shadow duration-500 group">
            ...
            <div className="mt-4 border-t-2 border-black pt-3 flex justify-between items-center">
              <div className="font-sans-condensed text-xs font-bold uppercase tracking-widest">
                Read the full report at <span className="underline decoration-2 decoration-red-800">news.gujab9.workers.dev</span>
              </div>
          ...
          <div className="flex items-center justify-between mt-4 px-1">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className={`flex items-center gap-2 font-sans-condensed font-bold text-xs border-2 border-black px-3 h-8 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-[2px] hover:translate-y-[2px] transition-all active:scale-95 ${isLiked(mainArticle)
              ...
              >
                ...
                <div className="flex justify-between items-end mt-2 z-10 pt-2 border-t border-gray-300 gap-2">
                  <div className="flex flex-col shrink-0">
                    <span className="font-sans-condensed text-[9px] uppercase font-bold text-gray-400">news.gujab9.workers.dev</span>
                  </div>
                  <div className="flex gap-2 shrink-0">
                    ...
                    <button
                      ...
                      className={`h-7 px-2 flex items-center gap-1 border border-black transition-colors shadow-[2px_2px_0px_0px_rgba(0,0,0,0.1)] hover:shadow-none hover:translate-x-[1px] hover:translate-y-[1px] active:scale-90 ${isLiked(article)
                          ? 'bg-black text-white'
