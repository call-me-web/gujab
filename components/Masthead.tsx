...
export const Masthead: React.FC<MastheadProps> = ({ currentPage, setPage, isScrolled, currentUser, onLogout, onLoginClick, onViewMyProfile }) => {
  ...
  return (
    <header className={`bg-paper sticky top-0 z-50 transition-all duration-500 ease-[cubic-bezier(0.4,0,0.2,1)] ${isScrolled ? 'py-2 shadow-lg border-b-2 border-black/80 backdrop-blur-sm bg-paper/95' : 'py-4 border-b-4 border-black'}`}>
